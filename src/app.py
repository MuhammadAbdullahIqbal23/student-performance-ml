...
try:
    ...
    print("Required modules not found. Make sure model.py and data_generator.py are in the same directory.")
...
def home():
    ...
    <body>
        ...
        <p>This API provides endpoints for predicting student academic performance based on various factors.</p>

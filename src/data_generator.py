...
class StudentDataGenerator:
    ...
    def generate_dataset(self):
        ...
        genders = np.random.choice(['Male', 'Female', 'Other'], self.num_students, p=[0.45, 0.50, 0.05])
    ...
    def save_dataset(self, data, filename="student_performance_dataset.csv"):
        ...
        print(f"Target variable range: {data['final_score'].min():.2f} - {data['final_score'].max():.2f}")
